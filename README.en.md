...
<a href="https://github.com/MarcoG-h/DSH-Launcher/releases/tag/v3.0.5"><img src="https://img.shields.io/badge/v3.0.5-Release-2EA44F?style=flat" alt="v3.0.5"></a>
...
| --- | --- | --- |
| [Installer exe](https://github.com/MarcoG-h/DSH-Launcher/releases/download/v3.0.5/DSH.Launcher.Setup.3.0.5.exe) | NSIS installer; creates desktop / Start menu shortcuts automatically | ~100 MB |
