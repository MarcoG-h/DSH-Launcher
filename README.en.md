...
| --- | --- | --- |
| [Installer exe](https://github.com/MarcoG-h/DSH-Launcher/releases/download/v3.1.1/DSH.Launcher.Setup.3.1.1.exe) | NSIS installer; creates desktop / Start menu shortcuts automatically | ~100 MB |
