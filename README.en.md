...
| --- | --- | --- |
| [Installer exe](https://github.com/MarcoG-h/DSH-Launcher/releases/download/v3.1.4/DSH.Launcher.Setup.3.1.4.exe) | NSIS installer; creates desktop / Start menu shortcuts automatically | ~100 MB |
