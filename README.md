...
<a href="https://github.com/MarcoG-h/DSH-Launcher/releases"><img src="https://img.shields.io/badge/v3.1.2-Release-2EA44F?style=flat" alt="v3.1.2"></a>
...
| 文件 | 说明 | 大小 |
| --- | --- | --- |
| [标准版 exe](https://github.com/MarcoG-h/DSH-Launcher/releases/download/v3.1.2/DSH.Launcher.Setup.3.1.2.exe) | NSIS 安装到系统,自动创建桌面 / 开始菜单快捷方式 | ~100 MB |
...
| [专业版Launcher](https://github.com/baihejiangnan/deepseek-harness-desktop) | 多实例系统，轻量化，新手不推荐（适配Win/linux/mac） | ~ 20 MB |
...
![快速离线部署 · 一键下载便携环境](screenshots/one-click-download.png)
