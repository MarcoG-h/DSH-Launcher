...
感谢 [baihejiangnan](https://github.com/baihejiangnan) 提供的「更好的右键菜单」插件（[dsh-session-context-menu](https://github.com/baihejiangnan/dsh-session-context-menu)）

期待您参与 DSH 插件生态建设，一起完善桌面封装端的体验。
