...
const zh: Record<string, string> = {
  ...
  'balance.localModel': '本地部署模型 · 无需 API Key / 余额查询',
  'balance.total': '总额',
  'balance.granted': '赠送',
  'balance.toppedUp': '充值',
  'balance.loading': '加载中…',
  ...
  'plugins.recommendedTitle': '推荐插件',
  'plugins.recommendedHint': '为启动器封装版本定制的插件，可提升交互体验',
  'plugins.installAllSelected': '一键安装',
  'plugins.restartHint': '安装或重装插件后会自动重启 DSH 使其生效。',
  'plugins.recommended.contextMenu.desc': '适配启动器版本 DSH 的右键菜单',
  // settings
  'settings.title': '设置',
  ...
  'settings.localModelHint': '本地部署模型(Ollama / LM Studio / vLLM 等)无需 API Key 与余额查询',
...
const en: Record<string, string> = {
  ...
  'balance.localModel': 'Local model · no API key / balance check needed',
  'balance.total': 'Total',
  ...
  'plugins.recommendedTitle': 'Recommended',
  'plugins.recommendedHint': 'Plugins tailored for the launcher build, enhancing the interaction experience.',
  'plugins.installAllSelected': 'Install Selected',
  'plugins.restartHint': 'Installing or reinstalling a plugin automatically restarts DSH to apply the change.',
  'plugins.recommended.contextMenu.desc': 'A context menu adapted for the launcher version of DSH.',
  ...
  'settings.localModelHint': 'Local self-hosted models (Ollama / LM Studio / vLLM …) need no API key or balance check',
